...
public class GlobalExceptionHandler {
    ...
    // Handle Path variable / parameters has wrong types 400
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleConstraintValidation(
    ...
    // Handle Database constraints validation 400
